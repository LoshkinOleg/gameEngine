...
namespace gl
{
    ...
    public:
        ...
        ModelId CreateResource(const std::vector<ObjData> objData, bool flipImages = true, bool correctGamma = true);

        std::vector<ObjData> ReadObjData(std::string_view path) const;
